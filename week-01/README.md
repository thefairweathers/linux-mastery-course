...
- **[Lab 1.1: Ubuntu Server VM Setup](labs/lab_01_ubuntu_vm_setup.md)** — Full walkthrough of downloading, installing, and configuring your Ubuntu Server VM with SSH verification
- **[Lab 1.2: Rocky Linux VM Setup](labs/lab_02_rocky_vm_setup.md)** — Same process for Rocky Linux 9, noting installer differences
