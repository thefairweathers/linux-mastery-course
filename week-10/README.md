...
[← Previous Week](../week-09/README.md) · [Next Week →](../week-11/README.md)
...
- **[Lab 10.1: Disk Management](labs/lab_01_disk_management.md)** — Add a virtual disk, partition it, create filesystems, mount them, and add to fstab
- **[Lab 10.2: LVM Operations](labs/lab_02_lvm_operations.md)** — Create a full LVM stack, format, mount, write data, then extend the LV and grow the filesystem
