---
title: "Week 4: Pipes, Redirection & The Unix Philosophy"
sidebar:
  order: 0
---
...
- **[Lab 4.1: Redirection Mastery](./lab-01-redirection-mastery)** — Exercises on redirecting stdout/stderr, appending, combining streams, and here documents
- **[Lab 4.2: Pipeline Challenges](./lab-02-pipeline-challenges)** — Solve 10 progressively harder problems using pipes and command chaining
