---
title: "Week 8: Bash Scripting Fundamentals"
sidebar:
  order: 0
---
...
- **[Lab 8.1: System Report Script](/linux-mastery-course/scaffolds/week-08/lab_01_system_report.sh)** — Write a script that generates a system health report with hostname, uptime, CPU, memory, disk, and top processes
- **[Lab 8.2: Service Checker Script](/linux-mastery-course/scaffolds/week-08/lab_02_service_checker.sh)** — Write a script that checks service status and optionally restarts failed services
