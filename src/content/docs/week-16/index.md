---
title: "Week 16: Building Images & Container Development Workflows"
sidebar:
  order: 0
---
...
- **[Lab 16.1: Dockerfile Mastery](./lab-01-dockerfile-mastery)** -- Write Dockerfiles for three progressively complex scenarios, optimize image sizes
- **[Lab 16.2: Containerize the Three-Tier App](./lab-02-containerize-three-tier)** -- Containerize the Flask API and nginx, wire all three tiers together manually
