---
title: "Week 11: Systemd, Services & the Boot Process"
sidebar:
  order: 0
---
...
- **[Lab 11.1: Service Management](./lab-01-service-management)** — Install and manage a web server on both distros, intentionally break it, diagnose with journalctl
- **[Lab 11.2: Custom Service & Timer](./lab-02-custom-service)** — Create a custom daemon with a systemd service unit and a cleanup timer
