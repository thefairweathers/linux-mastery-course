---
title: "Week 7: Processes, Jobs & System Monitoring"
sidebar:
  order: 0
---
...
- **[Lab 7.1: Process Investigation](./lab-01-process-investigation)** — Use ps, top, /proc to investigate running processes, trace relationships, and find port listeners
- **[Lab 7.2: Resource Monitoring](./lab-02-resource-monitoring)** — Build a monitoring checklist, practice with htop, vmstat, iostat, and use lsof to find port conflicts
