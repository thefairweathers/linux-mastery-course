---
title: "Week 13: Databases — PostgreSQL & MariaDB"
sidebar:
  order: 0
---
...
- **[Lab 13.1: Database Server Setup](./lab-01-database-server-setup)** — Install PostgreSQL on Ubuntu and MariaDB on Rocky, create databases and users, practice SQL, back up and restore
- **[Lab 13.2: Three-Tier Application](./lab-02-three-tier-app)** — Build the full three-tier app: PostgreSQL + Flask API + nginx reverse proxy with CRUD endpoints
