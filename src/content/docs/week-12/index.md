---
title: "Week 12: Web Servers, DNS & Service Infrastructure"
sidebar:
  order: 0
---
...
- **[Lab 12.1: Web Server Setup](./lab-01-web-server-setup)** — Configure nginx to serve static sites with virtual hosts, custom logs, and troubleshooting
- **[Lab 12.2: Reverse Proxy & DNS](./lab-02-reverse-proxy-and-dns)** — Run a Flask API behind nginx as a reverse proxy with local DNS via dnsmasq
