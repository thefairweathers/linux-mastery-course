...
- **[Lab 2.1: Filesystem Exploration](labs/lab_01_filesystem_exploration.md)** — Navigate the filesystem, explore key directories, compare Ubuntu and Rocky
- **[Lab 2.2: File Operations](labs/lab_02_file_operations.md)** — Create a mock project structure, practice file operations and wildcards
