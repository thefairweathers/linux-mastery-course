...
[← Previous Week](../week-16/README.md)
...
- **[Lab 17.1: Compose Three-Tier Stack](labs/lab_01_compose_three_tier.md)** -- Translate the manually-wired three-tier app into a Docker Compose stack with health checks, networks, and persistence
- **[Lab 17.2: Capstone Deployment](labs/lab_02_capstone_deployment.md)** -- Deploy the complete production stack with security hardening, automated backups, monitoring, and documentation
