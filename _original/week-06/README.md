...
- **[Lab 6.1: Package Management](labs/lab_01_package_management.md)** — Install, query, and manage packages on both distros side-by-side
- **[Lab 6.2: Repository Setup](labs/lab_02_repository_setup.md)** — Add third-party repositories on both distros, install software from them
