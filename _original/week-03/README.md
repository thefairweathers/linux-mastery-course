# Week 3: Reading, Searching & Manipulating Text

> **Goal:** View, search, filter, and transform text files using core Linux utilities.

[← Previous Week](../week-02/README.md) · [Next Week →](../week-04/README.md)
...
- **[Lab 3.1: Log Analysis](labs/lab_01_log_analysis.md)** — Analyze a sample web server access log to find errors, count hits, and extract patterns
- **[Lab 3.2: Text Pipeline](labs/lab_02_text_pipeline.md)** — Build progressively complex pipelines combining grep, cut, sort, uniq, and awk
